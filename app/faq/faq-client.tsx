...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer: 'You can start generating lyrics immediately after signing up. Free accounts get 1 generation per day, while premium subscribers get 30 generations daily.'
  },
  {
    category: 'Features',
  ...
  },
  {
    ...
    answer: 'Free users get 1 generation per day with our basic AI model and can favorite up to 3 lyrics. Premium subscribers get 30 generations and 30 lyrics optimizations daily, access to our pro AI model, editing tools, commercial usage rights, and can favorite up to 300 lyrics.'
  },
  {
    category: 'Subscription',
        ...
        <div className="mt-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Find answers to common questions about our AI lyrics generator and how it can help you create amazing songs.
            </p>
          </div>
